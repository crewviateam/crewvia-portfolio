        ...
        <div className="flex justify-between items-start hero-fade pt-20 md:pt-24">
          ...
          <div className="hidden md:flex text-right flex-col items-end gap-2 md:gap-3">
            ...
            <div className="flex gap-2 mt-2">
              {([
                { href: "https://linkedin.com/company/crewvia",  label: "LI", track: "hero-linkedin"  },
                { href: "https://instagram.com/crewvia",         label: "IG", track: "hero-instagram" },
...
function ExploreButton() {
  ...
  return (
    <a
      ...
      onClick={() => trackCta("explore_work")}
      onMouseEnter={() => { if (!ref.current) return; ref.current.style.background = "#2ec4b6"; ref.current.style.color = "#050505"; }}
      onMouseLeave={() => { if (!ref.current) return; ref.current.style.background = "transparent"; ref.current.style.color = "#2ec4b6"; }}
    >
      Explore Work
    </a>
  );
